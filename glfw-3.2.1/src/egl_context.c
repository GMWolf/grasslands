...
static const char* getEGLErrorString(EGLint error)
{
    switch (error)
    {
        ...
        case EGL_BAD_CONFIG:
            return "An EGLConfig argument does not name a valid EGL frame meshBuffer configuration";
        case EGL_BAD_CURRENT_SURFACE:
            return "The current surface of the calling thread is a window, pixel meshBuffer or pixmap that is no longer valid";
